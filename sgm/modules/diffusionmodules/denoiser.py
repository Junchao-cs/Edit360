    ...
    def forward(
        ...
        **additional_model_inputs,
        ...
        if is_front_view == True:
            network_output, kv_f_list = network(input * c_in, c_noise, cond, is_front_view, kv_f_list, **additional_model_inputs)
            network_output = network_output * c_out + input * c_skip
            return network_output, kv_f_list
        else:
            network_output, kv_f_list = network(input * c_in, c_noise, cond, is_front_view, kv_f_list, **additional_model_inputs)
            network_output = network_output * c_out + input * c_skip
            return network_output, kv_f_list
